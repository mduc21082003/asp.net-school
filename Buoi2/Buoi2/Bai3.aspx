<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bai3.aspx.cs" Inherits="Buoi2.WebForm3" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            Bài 3: Kiểm tra N có phải số nguyên tố không<br />
            <br />
            <asp:Label ID="Label7" runat="server" Text="N"></asp:Label>
&nbsp;
            <asp:TextBox ID="txtN1" runat="server" CssClass="td"></asp:TextBox>
            <br />
            <asp:Button ID="btnTinh2" runat="server" CssClass="button" OnClick="btnTinh0_Click" Text="Kiểm tra" Width="180px" />
            <br />
